...
public class InvoiceAsyncService {
    ...
    //Constructor
    public InvoiceAsyncService (InvoiceRepository invoiceRepository, PdfService pdfService, CloudinaryService cloudinaryService){
    ...
    public void processInvoicePDFAsync (Long invoiceId) {
        ...
        //after uploading the pdf on cloduinary and saving its url in invoiceUrl now delete the pdf file from temp
